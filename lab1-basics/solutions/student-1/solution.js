...
function runTests() {
    ...
    console.assert(validateEmail("a@b.v") === false, "Тест провален: слишком короткий TLD, не должен пройти");
    console.assert(validateEmail("aaa.z") === false, "Тест провален: слишком короткий email, не должен пройти");
    ...
    console.assert(validateEmail("name name@mail.com") === false, "Тест провален: пробел в имени, не должен пройти");
    console.assert(validateEmail("мяу@mail.com") === false, "Тест провален: кириллица не разрешена");
    console.assert(validateEmail("users@domain") === false, "Тест провален: нет TLD после точки");
