...
function runTests() {
    ...
    "Тест на обработку исключений (невалидные входные данные) провален");
    console.assert(testThrowsError(() => new Vehicle('Toyota', 'Camry', 2026), "Год выпуска не может быть больше текущего года"), 
    "Тест на обработку исключений (невалидные входные данные) провален");
    ...
    "Тест на обработку исключений (невалидные входные данные) провален");
    console.assert(testThrowsError(() => vehicle.year = 2026, "Год выпуска не может быть больше текущего года"), 
    "Тест на обработку исключений (невалидные входные данные) провален");
    vehicle.year = 2016;
    ...
    "Тест на обработку исключений (невалидные входные данные) провален");
    console.assert(testThrowsError(() => new Car('Honda', 'Civic', 2026), "Год выпуска не может быть больше текущего года"), 
    "Тест на обработку исключений (невалидные входные данные) провален");
    ...
    "Тест на обработку исключений (невалидные входные данные) провален");
    console.assert(testThrowsError(() => car.year = 2026, "Год выпуска не может быть больше текущего года"), 
    "Тест на обработку исключений (невалидные входные данные) провален");
    car.year = 2019;
    ...
    "Тест на обработку исключений (невалидные входные данные) провален");
    console.assert(testThrowsError(() => new ElectricCar('Teslaa', 'Model 3', 2026), "Год выпуска не может быть больше текущего года"), 
    "Тест на обработку исключений (невалидные входные данные) провален");
    ...
    "Тест на обработку исключений (невалидные входные данные) провален");
    console.assert(testThrowsError(() => electricCar.year = 2026, "Год выпуска не может быть больше текущего года"), 
    "Тест на обработку исключений (невалидные входные данные) провален");
    ...
    "Тест на обработку исключений (невалидные входные данные) провален");
    console.assert(testThrowsError(() => createCarFactory('Honda', 'Civic', 2026), "Ошибка создания Car: Год выпуска не может быть больше текущего года"), 
    "Тест на обработку исключений (невалидные входные данные) провален");
    ...
    "Тест на обработку исключений (невалидные входные данные) провален");
    console.assert(testThrowsError(() => myNewCar.year = 2026, "Год выпуска не может быть больше текущего года"), 
    "Тест на обработку исключений (невалидные входные данные) провален");
    myNewCar.year = 2023;
    ...
    "Тест на обработку исключений (невалидные входные данные) провален");
    console.assert(testThrowsError(() => createElectricCarFactory('Teslaa', 'Model 3', 2026), "Ошибка создания ElectricCar: Год выпуска не может быть больше текущего года"), 
    "Тест на обработку исключений (невалидные входные данные) провален");
    ...
    "Тест на обработку исключений (невалидные входные данные) провален");
    console.assert(testThrowsError(() => myElectricCar.year = 2026, "Год выпуска не может быть больше текущего года"), 
    "Тест на обработку исключений (невалидные входные данные) провален");
